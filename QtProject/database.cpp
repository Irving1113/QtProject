...
void Database::connect() {
    ...
    if (is_open){
        ...
        db = QSqlDatabase::addDatabase("QSQLITE", "CONNECTION_" + QString::number(connection_count++, 10));
        db.setDatabaseName("C:\\Users\\Alienware\\Documents\\WeChat Files\\wxid_5hachc11o02w12\\FileStorage\\MsgAttach\\96913830104c0fb6e2faf62a3cfc31f4\\File\\2022-06\\first_window\\first_window\\first_window\\timer_gyf.db");     //修改为本地.db文件的绝对路径
